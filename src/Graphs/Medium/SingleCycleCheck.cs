 ...
 * Single Cycle Check
    ...
    Write a function that returns true if the jumps in the array form a single cycle. A single cycle occurs if, starting at any index in the array and following the jumps,
    every element in the array is visited exactly once before landing back on the starting index. Note that the jumps can be positive or negative.
